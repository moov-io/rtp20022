...
// The serial number generated by serialFunc should be exactly 10 characters long.
//
...
func AdmnMessageID(ts time.Time, participantID string,serialFunc func() string) string {
